 ...
 */
public class ProfesoresInteresados extends javax.swing.JFrame {
    ArrayList<String> profesores;
    DefaultTableModel modelo = new DefaultTableModel();
    /**
     * Creates new form VentanaInformativa
     */
    public ProfesoresInteresados() {
        initComponents();
    ...
    {   
        this.setTitle("Profesores interados en el "+curso);
        modelo = new DefaultTableModel();
        modelo.addColumn("Profesor");
        profesores = Consultas.ProfesoresInteresadosEnCurso(curso);
        for (int i = 0; i < profesores.size(); i= i+2) {
            String[] temp = new String[1];
            temp[0]= profesores.get(i);
            modelo.addRow(temp);
    ...
    private void TablaProfesoresMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablaProfesoresMouseClicked
        int index = TablaProfesores.getSelectedRow();
        String profe = (TablaProfesores.getValueAt(index, 0).toString());
        for (int i = 0; i < profesores.size(); i= i+2) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProfesoresInteresados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProfesoresInteresados().setVisible(true);
            }
        });
    }
